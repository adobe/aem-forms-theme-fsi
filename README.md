...
This is the standard FSI theme for Adobe Experience Manager (AEM) Forms.
...
```
npm install --save @aemforms/af-fsi-theme
```

Then just import the files as you would other CSS.

```
import '@aemforms/af-fsi-theme/dist/theme.css';
```
